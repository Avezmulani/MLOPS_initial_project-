...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        logging.info('Entered get_data_transformer_object method of DataTransformation')

        try:
            numerical_transformer = StandardScaler()
            min_max_scaler = MinMaxScaler()
            logging.info("StandardScaler and MinMaxScaler Initialized")
            ...
            logging.info(f'Exited get_data_transfomer_object method of DataTransformation class')
    ...
    def initiate_data_transformation(self) ->DataTransformationArtifact:
        try:
            ...
            logging.info(f'Custom Transformation applied to train and test data')
